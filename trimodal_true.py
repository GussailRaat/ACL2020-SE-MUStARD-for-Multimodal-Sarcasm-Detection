...
def featuresExtraction_fastext(foldNum, exMode):
    ...
    path = '/home1/dushyant/PhD_thesis/myExperiments/MOSEI/CMU-MultimodalDataSDK-master/myPaper/acceptPaper/ACL-sarcasm/dataPrepration/MUStARD-master/dataset'+str(exMode)+'_fasttext/sarcasmDataset_speaker_dependent_'+str(exMode)+'_'+str(foldNum)+'.npz'
...
def featuresExtraction_original(foldNum, exMode):
    ...
    sarcasm = np.load('/home1/dushyant/PhD_thesis/myExperiments/MOSEI/CMU-MultimodalDataSDK-master/myPaper/acceptPaper/ACL-sarcasm/dataPrepration/MUStARD-master/dataset'+str(exMode)+'_original/sarcasmDataset_speaker_dependent_'+ exMode +'.npz', mmap_mode='r', allow_pickle=True)
